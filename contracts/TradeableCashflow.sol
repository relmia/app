...
import {BillboardFlow, ISuperToken, ISuperfluid} from "./BillboardFlow.sol";
...
contract TradeableCashflow is ERC721, BillboardFlow {
    constructor(
        address owner,
        string memory _name,
    ...
    ) ERC721(_name, _symbol) BillboardFlow(host, acceptedToken, owner) {
        _mint(owner, 1);
    }
