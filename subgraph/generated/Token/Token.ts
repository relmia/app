...
export class SafeMint extends ethereum.Event {
  get params(): SafeMint__Params {
    return new SafeMint__Params(this);
  }
}

export class SafeMint__Params {
  _event: SafeMint;

  constructor(event: SafeMint) {
    this._event = event;
  }
